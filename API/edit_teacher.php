...
if (isset($_POST['editTeacher'])) {
    ...
    echo $teacher_id;
    $url4 = "http://localhost:5000/users/show/$teacher_id";
            ...
            <div class="">
                <form action="" method="post">
                    ...
                    foreach ($list as $value) {
                        ...
                        echo '</div>';
                        echo '</div>';
                        echo "<input type='hidden' id='user_id' name='user_id' value='$teacher_id'>";
                    }
                    ?>
                    <div class="">
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result == 'not ok') {
                        ...
                        window.location.href = 'teacher.php?id=' + user_id;
                    }
                    console.log(result)
                }
            })
